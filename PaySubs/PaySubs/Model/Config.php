...
/**
 * Config model that is aware of all \PaySubs\PaySubs payment methods
 * Works with PaySubs-specific system configuration
...
class Config extends AbstractConfig
{
    ...
    /** Currency codes supported by PaySubs methods @var string[] */
    protected $_supportedCurrencyCodes = ['ZAR', 'BWP', 'NAD'];
    ...
    /**
     * Return buyer country codes supported by PaySubs
     *
     * @return string[]
     */
    ...
    {
        return $this->_assetRepo->getUrl( 'PaySubs_PaySubs::images/logo.png' );
    }

    /**
     * Get "What Is PaySubs" localized URL
     * Supposed to be used with "mark" as popup window
     *
     * @return string
     */
    public function getPaymentMarkWhatIsPaySubs()
    {
        return 'PaySubs Payment gateway';
    }

    /**
     * Mapper from PaySubs-specific payment actions to Magento payment actions
     *
     * @return string|null
     */
    ...
    /**
     * _mapPaySubsFieldset
     * Map PaySubs config fields
     *
     * @param string $fieldName
     * @return string|null
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     */
    protected function _mapPaySubsFieldset( $fieldName )
    {
    ...
    {
        return $this->_mapPaySubsFieldset( $fieldName );
    }
}
