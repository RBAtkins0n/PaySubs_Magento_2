...
class Request extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \PaySubs\PaySubs\Helper\Data $paysubsHelper
    ...
    public function _prepareLayout()
    {
        $this->setMessage( 'Redirecting to PaySubs' )
            ...
            ->setFormMethod( 'POST' )
            ->setFormAction( $this->_paymentMethod->getPaySubsUrl() )
            ->setFormData( $this->_paymentMethod->getStandardCheckoutFormFields() )
            ->setSubmitForm( '<script type="text/javascript">document.getElementById( "paysubs_checkout" ).submit();</script>' );
